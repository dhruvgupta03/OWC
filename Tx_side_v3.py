        ...
        with open(file_path, "rb") as file:
            ...
            while bytes_sent < file_size:
                ...
                if ack == b'\x06':  # ACK (0x06)
                    ...
                    print(f"Packet {packet_id} not acknowledged, resending...")
                    file.seek(bytes_sent)  # Rewind the file pointer
        ser.write(b'\x17')
...
# Example usage
send_file_via_uart("C:/Users/dell/OneDrive/Desktop/OWC ppt.pptx", "COM5")
